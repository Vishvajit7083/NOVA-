    ...
    return (
      <div className="min-h-screen bg-[#F8F9FA] text-zinc-900 py-20 text-center">
        ...
        <button
          ...
          className="mt-4 px-6 py-2.5 bg-[#EB0028] text-white text-xs font-bold rounded-xl shadow-sm"
        >
          Return to Store
        </button>
      </div>
    ...
    <div id="order-confirmation-page" className="min-h-screen bg-[#F8F9FA] text-zinc-900 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="text-center space-y-4 bg-white border border-zinc-200 rounded-3xl p-8 sm:p-10 shadow-sm">
          ...
          <div className="inline-flex items-center space-x-2 bg-[#F8F9FA] px-4 py-2 rounded-xl border border-zinc-200 text-xs font-mono text-zinc-700">
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-6 space-y-6 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-zinc-200 pb-4">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-[#F8F9FA] hover:bg-zinc-100 text-xs font-bold text-zinc-900 border border-zinc-200 flex items-center space-x-1.5 transition-colors"
            >
          ...
          <div className="p-4 bg-[#F8F9FA] rounded-xl border border-zinc-200 space-y-1 text-xs text-zinc-500">
        ...
        <div className="bg-white border border-zinc-200 rounded-2xl p-6 space-y-4 shadow-sm">
          <h3 className="text-sm font-bold text-zinc-900 uppercase tracking-wider border-b border-zinc-200 pb-3">
          ...
          <div className="pt-4 border-t border-zinc-200 flex items-center justify-between text-sm font-bold text-zinc-950">
            <span>Total Paid ({currentOrder.paymentDetails?.methodLabel || currentOrder.paymentMethod})</span>
            <span className="text-base text-[#EB0028]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
          <button
            ...
            className="w-full sm:w-auto px-5 py-3 rounded-xl bg-white hover:bg-zinc-50 border border-zinc-200 text-zinc-900 font-bold text-xs flex items-center justify-center space-x-2 shadow-sm transition-colors"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto px-7 py-3 rounded-xl bg-[#EB0028] hover:bg-[#c90023] text-white font-bold text-xs flex items-center justify-center space-x-2 shadow-md transition-colors"
          >
